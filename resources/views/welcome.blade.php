            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" data-bs-toggle="modal" data-bs-dismiss="modal"
                            href="#exampleModalToggle2" role="button">Sim</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" value="Sim" name="consentimento_lgpd"
                                id="lgpd-consentimento">
                            <label for="lgpd-consentimento" class="form-check-label">Estou ciente que os dados serão
                                tratados conforme a LGPD.</label>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade" id="legenda-modal" tabindex="-1" aria-labelledby="legenda-modal-label" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Responda a pesquisa utilizando uma escala de 0 a 10. <br>Onde <strong>0</strong> equivale a
                        <strong>"Muito Ruim"</strong> e <strong>10</strong> equivale a <strong>"Excelente"</strong>.</p>
                </div>
                <div class="modal-footer">
